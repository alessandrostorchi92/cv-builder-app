...
<div style="margin: 0 auto; font-family: Montserrat;">

    <table style="width:100%; height:100%; border-spacing: 0; position: relative">

        {#if $isAllowed && $isPrivacyPolicyApproved}
            <div style="position: absolute; left: 75%; z-index: 0; margin-right: 0px; margin-top: 280px; width: 240px; ">
                <div style="
                    width: 700px; 
                    height: 700px; 
        ...
        <tbody>
            ...
            <tr>
                ...
                {#if $formDataStore.filePicture !== "" || $formDataStore.name !== ""  || $formDataStore.surname !== ""  || $formDataStore.profession !== ""  || $formDataStore.nationality !== ""  || $formDataStore.birthPlace !== ""  || $formDataStore.birthDate !== ""  || $formDataStore.address !== ""  || $formDataStore.email !== ""  || $formDataStore.phone!== ""  || $formDataStore.languagesSkills.some((selectedLanguage) => selectedLanguage.lang !== "")  || $formDataStore.digitalSkills.some((digitalSkill) => digitalSkill.skill !== "")}
                    ...
                    <td style="width:30%; background-color:#efefef; vertical-align:top; padding: 0 20px;">
                            ...
                            <div style="text-align:center; margin-bottom:30px; margin-top:40px;">
                                ...
                                {#if $formDataStore.filePicture}
                                    <img src="{$formDataStore.filePicture}" alt="Immagine Profilo" style="width:200px; margin: -16px 0 0 0;border-radius:400px">
                                {/if}
                            ...
                            <div>
                                ...
                                <p style="display: flex;align-items: top; gap: 4px; margin: 16px 2px;">
                                    ...
                                    {#if $formDataStore.address}
                                        <!-- Icona Residenza -->
                                        <svg style="margin-right:6px" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 16 16">
                                ...
                                <p style="display: flex; align-items: center; gap: 4px; margin: 16px 2px;">
                                    ...
                                    {#if $formDataStore.phone}
                                        <!-- Icona Telefono -->
                                        <svg style="margin-right:6px" width="14px" height="14px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M20 14C20 17.7712 20 19.6569 18.8284 20.8284C17.6569 22 15.7712 22 12 22C8.22876 22 6.34315 22 5.17157 20.8284C4 19.6569 4 17.7712 4 14V10C4 6.22876 4 4.34315 5.17157 3.17157C6.34315 2 8.22876 2 12 2C15.7712 2 17.6569 2 18.8284 3.17157C20 4.34315 20 6.22876 20 10" stroke="{$formDataStore.selectedColor || 'black'}" stroke-width="1.5" stroke-linecap="round"></path> <path d="M15 19H9" stroke="black" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
                ...
                <td style="width:70%; vertical-align:top; padding:20px; position: relative;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {#if $formDataStore.isProtectedCategory}
                                        <td style="font-size: 1.2rem;"><span style="color: {$formDataStore.selectedColor};">Categoria protetta:</span><span style="margin-left: 5px">{$formDataStore.isProtectedCategory}</span></td>
                                    {/if}
                                    
                                    {#if $formDataStore.drivingLicences.length > 0 || $formDataStore.hasOwnCar}
                                        <td style="font-size: 1.2rem;"><span style="color: {$formDataStore.selectedColor}; margin-left: 20px;">Automunito:</span>
                                        <span style="margin-left: 5px">{$formDataStore.drivingLicences}</span></td>
                                    {/if}
                            ...
                            {#each $formDataStore.jobs as job (job)}
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <h6 style="font-size:24px; color:#6d6d6d; margin: 12px 0 0 0;">
                                        ...
                                        <tr>
                                            ...
                                            {#if job.startDateWorkExperience || job.endDateWorkExperience }
                                                <span style="font-size: 16px;"><b>{formattedWorkAccademicDate(job.startDateWorkExperience)} / {job.endDateWorkExperience === "" ? "Presente" : formattedWorkAccademicDate(job.endDateWorkExperience)}</b></span>
                                            {/if}

                                            {#if job.workExperienceResults}
                                                <span style="margin-left: 5px;">{job.workExperienceResults}</span>
                                            {/if}
                            ...
                            {#each $formDataStore.educations as education (education)}
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="font-size:24px; color:#6d6d6d;margin: 12px 0 0 0;">

                                            {#if education.endDateAcademicEducation}
                                                <span style="margin-right: 5px;">{education.endDateAcademicEducation === "" ? "Presente" : formattedWorkAccademicDate(education.endDateAcademicEducation)} - </span>
                                            {/if}
                                            ...
                                            {#if education.educationType}
                                                <span style="margin-left: 5px;"> - {education.educationType} </span>
                                            {/if}
                                        ...
                                        <tr>
                                            ...
                                            {#if education.fieldOfStudy}
                                                <span style="font-size: 16px;">{education.fieldOfStudy}</span>
                                            {/if}

                                            {#if education.educationGoals}
                                                <span style="margin-left: 5px;"> - {education.educationGoals} </span>
                                            {/if}
                        ...
                        {#if $isAllowed && $isPrivacyPolicyApproved}
                            ...
                            <div style="display: flex;align-items: top;gap: 8px;position: absolute;top: 110%;">
                                ...
                                <p style="font-size:8px; color:#000; margin-top: 5px;">{currentCopyrightPolicy}</p>
             ...
             <!-- Box sotto la colonna grigia -->

            <tr>

                {#if $isAllowed && $isPrivacyPolicyApproved}

                    <td style="background-color:{$formDataStore.selectedColor || 'black'}; vertical-align:middle; padding:10px;">
                            ...
                            <div style="display: flex;align-items: center;justify-content: center;flex-direction: column;padding-top: 12px;">
                                <img src="{$formDataStore.userSignature}" alt="Firma digitale" style="margin: 0; width:60%; filter: brightness(0) invert(1);">
